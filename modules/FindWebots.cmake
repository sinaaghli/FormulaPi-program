...
macro(get_version_osx VERSION HOME)
	file(READ $ENV{WEBOTS_HOME}/Contents/Info.plist PLIST)
...
#get the Libraries
  find_library(WEBOTS_LIBRARY_CPP CppController PATHS ${WEBOTS_HOME}/lib/controller
                                  ${SEARCH_OPTIONS})
  find_library(WEBOTS_LIBRARY_C Controller PATHS ${WEBOTS_HOME}/lib/controller
                                ${SEARCH_OPTIONS})
